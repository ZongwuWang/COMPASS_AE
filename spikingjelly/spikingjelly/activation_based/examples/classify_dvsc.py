...
def main():
    ...
    parser.add_argument('-data-dir', type=str, help='root dir of DVS CIFAR10 dataset')
    parser.add_argument('-log-dir', type=str, default='./logs', help='root dir for saving logs and checkpoint')
