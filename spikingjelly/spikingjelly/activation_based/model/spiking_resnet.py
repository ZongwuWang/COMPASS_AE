...
def _spiking_resnet(arch, block, layers, pretrained, progress, spiking_neuron, **kwargs):
    ...
    if pretrained:
        ...
        if True:
            ...
            print(f"Load pretrained model for {arch}")
        else:
            # Load from local
            model.load_state_dict(torch.load("/root/spikingjelly/logs/pt/spiking_resnet18_b8_e90_sgd_lr0.1_wd0.0_ls0.1_ma0.2_ca1.0_sbn0_ra0_re0.1_aaugta_wide_size176_232_224_seed2020_T100/checkpoint_max_test_acc1.pth"))
    return model
